...
Vrať POUZE platný JSON objekt (bez markdown backticks, bez komentářů):
{
  ...
  "sklik": {
    "headlines": ["přesně 3 varianty, každý max 60 znaků"],
    "descriptions": ["přesně 2 varianty, každý max 150 znaků"]
  },
  "meta": {
    "mainTextVisible": "max 125 znaků – nejdůležitější sdělení v prvních 2 větách",
    "mainTextHidden": "pokračování textu s více detaily, libovolná délka",
    "headline": "max 40 znaků – krátký úderný nadpis pod fotku"
  }
}`;
